...
| 落地表结构/索引 | `../prd/10-data-model.md` | §3 DDL · §6 索引 |
| 页面/线框 | `../prd/15-ui.md` | 页面清单 · 线框 · 交互约定 |
| 选型/库版本 | `../prd/19-tech-stack.md` | §2 Go · §5 pgx/bun · §8 React · §9 Monaco |
| 模块协作流程 | `../prd/01-architecture.md` | §7（查询为例） |
| 异常/边界 | `../prd/14-edge-cases.md` | A–H 矩阵 |
| v1 范围 | `../prd/18-roadmap.md` | 别实现 v2 能力 |
