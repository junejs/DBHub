...
| 决策依据 | `../prd/11-decisions.md`（`D##`） |
| v1 边界 | `../prd/18-roadmap.md` |
...
| DDL 对照 | `../prd/10-data-model.md` | §3 DDL（B4） |
| 错误码目录 | `../prd/12-api-contract.md` | §4.3（B3） |
| 决策依据 | `../prd/11-decisions.md` | `D##`（C2） |
| v1 范围 | `../prd/18-roadmap.md` | §1 v2 延后项（C1） |
